...
sudo apt install -y tmux pipx python3-pynvim gawk git firetools shfmt shellcheck backintime-qt chromium ripgrep jq kazam playerctl virt-viewer ipmitool nfs-common autofs nvme-cli
